...
class GarminBasicWatchFaceApp extends Application.AppBase {
    ...
    // ─────────────────────────────────────────────────────────────────────
    // NATIVE GARMIN ON-WATCH MENU (WatchUi.Menu2)
    // ─────────────────────────────────────────────────────────────────────
    function getSettingsView() {
        ...
        menu.addItem(new WatchUi.MenuItem("Reset Defaults", "Tap to Restore", "ResetDefaults", {}));
...
class GarminSettingsDelegate extends WatchUi.Menu2InputDelegate {
    ...
    function onSelect(item) {
        ...
        if (id.equals("ThemeColor")) {
            ...
            item.setSubLabel("Defaults Restored!");
        }
