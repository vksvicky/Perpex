...
def _slot_center(slot_id, w, h):
    ...
    if w == 320 and h == 360:
        dx = {1: 0, 2: -46, 3: 46, 4: -46, 5: 46, 6: 0}
        dy = {1: -54, 2: -28, 3: -28, 4: 28, 5: 28, 6: 54}
    elif w == 240:
        dx = {1: 0, 2: -34, 3: 34, 4: -34, 5: 34, 6: 0}
        dy = {1: -40, 2: -22, 3: -22, 4: 22, 5: 22, 6: 40}
    elif w == 260:
        dx = {1: 0, 2: -37, 3: 37, 4: -37, 5: 37, 6: 0}
        dy = {1: -43, 2: -24, 3: -24, 4: 24, 5: 24, 6: 43}
    elif w == 280:
        dx = {1: 0, 2: -40, 3: 40, 4: -40, 5: 40, 6: 0}
        dy = {1: -46, 2: -26, 3: -26, 4: 26, 5: 26, 6: 46}
    else:
        dx = {1: 0, 2: int(-37*s), 3: int(37*s), 4: int(-37*s), 5: int(37*s), 6: 0}
        dy = {1: int(-43*s), 2: int(-24*s), 3: int(-24*s),
              4: int(24*s),  5: int(24*s),  6: int(43*s)}
